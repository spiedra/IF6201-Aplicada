...
*/
ALTER PROCEDURE PRODUCTO.OBTENER_PRODUCTO_BY_ID
	@param_ID_PRODUCTO INT
AS 
BEGIN
	IF EXISTS (SELECT [ID_PRODUCTO] FROM [PRODUCTO].[tb_PRODUCTO] WHERE [ID_PRODUCTO] = @param_ID_PRODUCTO)
		BEGIN
			SELECT 
			[ID_PRODUCTO]
			, [NOMBRE]
